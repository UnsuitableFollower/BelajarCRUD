...
namespace BelajarCRUD
{
    public partial class FrmBelajarCRUD : Form
    {
        ...
        MySqlConnection conn = new MySqlConnection("datasource=localhost;port=3306;" + "Initial Catalog='db_crud'; username=root;password=");
        ...
        private void dgvCRUD_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtId.Text = dgvCRUD.CurrentRow.Cells[8].Value.ToString();
            txtNama.Text = dgvCRUD.CurrentRow.Cells[1].Value.ToString();
